...
static const br_x509_trust_anchor NUSA_CA_TAS[121] = {
	{
...
const br_x509_trust_anchor *nusaCaTrustAnchors(void) { return NUSA_CA_TAS; }
size_t nusaCaTrustAnchorsCount(void) { return 121; }
